  ...
  implements Serializable
{
  ...
  public String toString()
  {
    return 
      ...
      getClass().getName() + "(format=" + this.format + ", offset=" + this.offset + ", duration=" + this.duration + ", audioAttributes=" + this.audioAttributes + ", videoAttributes=" + this.videoAttributes + ")";
  }
}
